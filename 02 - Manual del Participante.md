...
├── ejercicio_3_oee.R
├── ejercicio_4_dashboard_completo.R
│
├── datos/
...
<blockquote>
<p>⏱️ <strong>Tiempo estimado:</strong> 2-3 minutos</p>
</blockquote>
<h3 id="paso-4-verificar-instalación">Paso 4: Verificar Instalación</h3>
<pre class=" language-r"><code class="prism  language-r"><span class="token comment"># Verificar que se carguen sin errores</span>
...
<span class="token comment"># Si no hay errores, ¡estás listo!</span>
print<span class="token punctuation">(</span><span class="token string">"✅ Configuración exitosa"</span><span class="token punctuation">)</span>

</code></pre>
<hr>
<h1 id="módulo-2-fundamentos">MÓDULO 2: FUNDAMENTOS</h1>
<div align="center"> <img src="https://shiny.posit.co/images/shiny-solo.png" alt="Shiny Logo" height="70"> </div>
<h2 id="⏰-horario-0830-1000-90-minutos">⏰ Horario: 08:30-10:00 (90 minutos)</h2>
<h2 id="📝-ejercicio-1-primera-app-interactiva">📝 EJERCICIO 1: Primera App Interactiva</h2>
<h3 id="objetivo">Objetivo:</h3>
<p>Crear una aplicación básica que muestre producción y calcule % de meta.</p>
<h3 id="paso-a-paso">Paso a Paso:</h3>
<h4 id="crear-nuevo-archivo">1. Crear Nuevo Archivo</h4>
<ul>
<li>Menú: <strong>File → New File → R Script</strong></li>
<li>Guardar como: <strong>"ejercicio_1_basico.R"</strong></li>
</ul>
<h4 id="copiar-el-código-base">2. Copiar el Código Base</h4>
...
ui <span class="token operator">&lt;-</span> page_sidebar<span class="token punctuation">(</span>
  title <span class="token operator">=</span> <span class="token string">"Mi Primera App Industrial"</span><span class="token punctuation">,</span>
  
  sidebar <span class="token operator">=</span> sidebar<span class="token punctuation">(</span>
    h4<span class="token punctuation">(</span><span class="token string">"Control de Producción"</span><span class="token punctuation">)</span><span class="token punctuation">,</span>
    sliderInput<span class="token punctuation">(</span><span class="token string">"produccion"</span><span class="token punctuation">,</span> 
                <span class="token string">"Unidades Producidas:"</span><span class="token punctuation">,</span> 
    ...
    sliderInput<span class="token punctuation">(</span><span class="token string">"meta"</span><span class="token punctuation">,</span> 
                <span class="token string">"Meta de Producción:"</span><span class="token punctuation">,</span> 
                min <span class="token operator">=</span> <span class="token number">0</span><span class="token punctuation">,</span> max <span class="token operator">=</span> <span class="token number">1000</span><span class="token punctuation">,</span> value <span class="token operator">=</span> <span class="token number">800</span><span class="token punctuation">)</span>
  <span class="token punctuation">)</span><span class="token punctuation">,</span>
  
  layout_columns<span class="token punctuation">(</span>
...
<ul>
<li><strong>Inputs numéricos</strong> (<code>numericInput</code>)</li>
...
server <span class="token operator">&lt;-</span> <span class="token keyword">function</span><span class="token punctuation">(</span>input<span class="token punctuation">,</span> output<span class="token punctuation">)</span> <span class="token punctuation">{</span>
  ...
  fpy_valor <span class="token operator">&lt;-</span> reactive<span class="token punctuation">(</span><span class="token punctuation">{</span>
...
<h3 id="📍-ejercicio-práctico">📍 Ejercicio Práctico:</h3>
<ol>
<li>Ejecutar la app</li>
<li>Probar con diferentes valores</li>
<li><strong>Reto:</strong> Agregar una alerta cuando FPY &lt; 95%</li>
</ol>
<hr>
<h1 id="☕-receso">☕ RECESO</h1>
<div align="center"> <img src="https://posit.co/wp-content/themes/Posit/assets/images/posit-logo-2024.svg" alt="Posit Logo" height="60"> </div>
<h2 id="⏰-horario-1000-1100-60-minutos">⏰ Horario: 10:00-11:00 (60 minutos)</h2>
<h3 id="descanso-e-intermedio-de-alumnos">Descanso e Intermedio de Alumnos</h3>
<p><strong>Aprovecha este tiempo para:</strong></p>
<ul>
<li>☕ Tomar un café o refrigerio</li>
<li>💬 Conversar con otros participantes</li>
<li>📱 Revisar tus redes sociales</li>
<li>🔄 Repasar lo visto en la primera parte</li>
<li>💻 Experimentar con los ejercicios</li>
<li>❓ Preparar dudas para la segunda parte</li>
</ul>
<p><strong>Tips para la segunda parte:</strong></p>
<ul>
<li>🔋 Asegúrate de que tu laptop esté cargada</li>
<li>🌐 Verifica tu conexión a internet</li>
<li>📁 Ten listos tus archivos del proyecto</li>
<li>💾 Guarda tu progreso antes del receso</li>
</ul>
<hr>
<h1 id="módulo-3-kpis">MÓDULO 3: KPIS</h1>
<h2 id="⏰-horario-1100-1145-45-minutos">⏰ Horario: 11:00-11:45 (45 minutos)</h2>
<h2 id="📊-ejercicio-3-calculadora-oee">📊 EJERCICIO 3: Calculadora OEE</h2>
<h3 id="objetivo-2">Objetivo:</h3>
<p>Implementar el cálculo completo de OEE con sus 3 componentes.</p>
<h3 id="fórmulas-a-implementar">Fórmulas a Implementar:</h3>
<pre><code>Disponibilidad = (Tiempo Planeado - Downtime) / Tiempo Planeado

Rendimiento = (Unidades × Ciclo Ideal) / Tiempo Operativo
...
<h3 id="interfaz-de-la-app">Interfaz de la App:</h3>
<p><strong>Inputs (Sidebar):</strong></p>
<ul>
<li>⏰ Tiempo Planeado (min)</li>
<li>🛑 Tiempo de Paro (min)</li>
<li>📦 Unidades Producidas</li>
<li>⏱️ Tiempo de Ciclo Ideal (min)</li>
<li>✅ Unidades Buenas</li>
</ul>
<p><strong>Outputs (Main):</strong></p>
<ul>
<li>📈 OEE Total (%) + Clasificación</li>
<li>📊 Disponibilidad (%)</li>
<li>📊 Rendimiento (%)</li>
<li>📊 Calidad (%)</li>
<li>📉 Gráfico de componentes</li>
<li>📍 Análisis detallado</li>
</ul>
<h3 id="interpretación-de-resultados">Interpretación de Resultados:</h3>
<p>OEE</p>
<p>Clasificación</p>
<p>Color</p>
<p>Acción</p>
...
<pre><code>Tiempo Planeado: 480 min (8 horas)
Downtime: 45 min
Unidades Producidas: 450
Ciclo Ideal: 1 min/unidad
Unidades Buenas: 430

</code></pre>
<p><strong>Cálculos:</strong></p>
<pre><code>Disponibilidad = (480 - 45) / 480 = 90.6%
Rendimiento = (450 × 1) / 435 = 103.4% → 100% (máx)
Calidad = 430 / 450 = 95.6%

OEE = 90.6% × 100% × 95.6% = 86.6% ✅ World Class!

</code></pre>
<hr>
<h1 id="módulo-4-dashboard-completo">MÓDULO 4: DASHBOARD COMPLETO</h1>
<h2 id="⏰-horario-1145-1250-65-minutos">⏰ Horario: 11:45-12:50 (65 minutos)</h2>
<h2 id="🎯-ejercicio-4-dashboard-integrador">🎯 EJERCICIO 4: Dashboard Integrador</h2>
<h3 id="objetivo-final">Objetivo Final:</h3>
<p>Crear un dashboard profesional con múltiples KPIs, gráficos y análisis.</p>
<h3 id="características-principales">Características Principales:</h3>
<h4 id="panel-de-kpis">1. <strong>Panel de KPIs</strong></h4>
<pre class=" language-r"><code class="prism  language-r">layout_columns<span class="token punctuation">(</span>
  value_box<span class="token punctuation">(</span>title <span class="token operator">=</span> <span class="token string">"OEE"</span><span class="token punctuation">,</span> value <span class="token operator">=</span> textOutput<span class="token punctuation">(</span><span class="token string">"kpi_oee"</span><span class="token punctuation">)</span><span class="token punctuation">)</span><span class="token punctuation">,</span>
  value_box<span class="token punctuation">(</span>title <span class="token operator">=</span> <span class="token string">"MTBF"</span><span class="token punctuation">,</span> value <span class="token operator">=</span> textOutput<span class="token punctuation">(</span><span class="token string">"kpi_mtbf"</span><span class="token punctuation">)</span><span class="token punctuation">)</span><span class="token punctuation">,</span>
  value_box<span class="token punctuation">(</span>title <span class="token operator">=</span> <span class="token string">"FPY"</span><span class="token punctuation">,</span> value <span class="token operator">=</span> textOutput<span class="token punctuation">(</span><span class="token string">"kpi_fpy"</span><span class="token punctuation">)</span><span class="token punctuation">)</span><span class="token punctuation">,</span>
...
<pre class=" language-r"><code class="prism  language-r">sidebar<span class="token punctuation">(</span>
  ...
  checkboxInput<span class="token punctuation">(</span><span class="token string">"auto_refresh"</span><span class="token punctuation">,</span> <span class="token string">"Actualización automática"</span><span class="token punctuation">)</span><span class="token punctuation">,</span>
...
library<span class="token punctuation">(</span>rsconnect<span class="token punctuation">)</span>
...
<pre class=" language-r"><code class="prism  language-r"><span class="token comment"># Publicar app actual</span>
...
<span class="token comment"># O usar el botón Publish nuevamente</span>
...
<ul>
<li>Aplicar a un caso real de tu contexto</li>
